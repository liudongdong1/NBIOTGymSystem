...
<html>
<head>
    <title>${MemberPssw.username}的主页</title>
...
<body background="img/password.jpg" style=" background-repeat:no-repeat ;
...
<div class="col-xs-6 col-md-offset-3" style="position: relative;">
    <div class="panel panel-primary ">
        ...
        <div class="panel-body">
            <form method="post" action="member_repasswd_do" class="form-inline" id="repasswd">
